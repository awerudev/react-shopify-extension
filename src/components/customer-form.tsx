        ...
        >
                    ...
                    className={cn(
                      ...
                      nameChangeData.predictions.length
                        ? salutation ===
                          ...
                          ? "border-border_confirmed bg-input_confirmed"
                          : "border-yellow-400"
                ...
                render={() => (
                  <FormItem>
                    ...
                    <FormControl
                      className={cn(
                        "",
                        isConfirmed ? "border border-border_confirmed" : "",
          ...
          <div className="flex justify-end">
            <Button
              ...
              className="bg-[#0b539b] w-1/2 hover:bg-[#03386e]"
            >
